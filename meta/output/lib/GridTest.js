...
$pyjs['loaded_modules']['GridTest'] = function (__mod_name__) {
	...
	$m['isWin'] = $p['___import___']('learning.isWin', null, null, false);
	$m['isFull'] = $p['___import___']('learning.isFull', null, null, false);
	...
	$m['GridWidget'] = (function(){
		...
		$method = $pyjs__bind_method2('__init__', function() {
			...
			optional_args = $p['dict']([['TD_CONSTS', (typeof TD_C == "undefined"?$m['TD_C']:TD_C)], ['MAX', '1'], ['MIN', 2]]);
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('onClick', function(sender) {
			...
			if ($p['bool'](($p['bool']($and1=$p['hasattr'](self, 'ai_first'))?$p['op_eq'](sender, $p['getattr'](self, 'ai_first')):$and1))) {
				...
				$p['printFunc']([$p['getattr']($p['getattr'](self, 'state'), 'boards')], 1);
				...
				self['grid_to_state']();
				$p['getattr']($p['getattr'](self, 'state'), 'nextPiece')['__setitem__'](2, $p['getattr'](self, 'max_player'));
				$p['printFunc'](['onClick'], 1);
				$p['printFunc'](['player is ', $p['getattr']($p['getattr'](self, 'state'), 'nextPiece')], 1);
				self['state']['printInfo']();
				self['state'] = $pyjs_kwargs_call(null, $m['ab'], null, null, [{'optional_args':$p['dict']([['TD_CONSTS', $p['getattr'](self, 'TD_CONSTS')], ['MIN', $p['getattr'](self, 'min_player')], ['MAX', $p['getattr'](self, 'max_player')]])}, $p['getattr'](self, 'state'), $p['getattr'](self, 'TD_CONSTS'), true])['__getitem__'](1);
				self['state']['printInfo']();
				self['state_to_grid']();
			}
			return null;
	...
	, 1, [null,null,['self'],['sender']]);
		...
		$method = $pyjs__bind_method2('will_buttons', function(y_board, x_board) {
			...
			playable = true;
			if ($p['bool'](($p['bool']($or1=$m['isWin'](board['__getitem__'](piece['__getitem__'](0))['__getitem__'](piece['__getitem__'](1))))?$or1:$m['isFull'](board['__getitem__'](piece['__getitem__'](0))['__getitem__'](piece['__getitem__'](1)))))) {
				playable = false;
			}
			if ($p['bool'](($p['bool']($and3=!$p['bool']($m['isWin'](board['__getitem__'](y_board)['__getitem__'](x_board))))?!$p['bool']($m['isFull'](board['__getitem__'](y_board)['__getitem__'](x_board))):$and3))) {
