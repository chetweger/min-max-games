...
$pyjs['loaded_modules']['GridTest'] = function (__mod_name__) {
	...
	, 1, [null,null,['self'],['sender']]);
		...
		$method = $pyjs__bind_method2('state_to_grid', function() {
			...
			var y_cell,$iter3_type,$iter1_iter,$iter4_type,$iter2_type,$iter4_iter,$iter3_idx,$iter2_iter,$iter3_iter,x_board,$iter1_array,$iter1_nextval,$iter2_idx,b,$iter3_array,y_board,$iter2_nextval,$iter1_type,g,$iter4_nextval,board,$iter4_idx,x_cell,$iter1_idx,$iter4_array,$iter3_nextval,$iter2_array;
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('grid_to_state', function() {
			...
			var $iter5_nextval,x,$or1,$iter6_idx,$or2,$iter6_type,$iter5_array,$iter6_array,$iter5_iter,$iter5_idx,y,$iter5_type,$iter6_iter,$iter6_nextval,next_state;
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('init', function() {
			...
			var $iter10_nextval,y_cell,$iter8_iter,$iter10_iter,$iter9_iter,$iter9_nextval,$iter9_idx,$iter7_type,$iter9_type,x_board,$iter8_idx,$iter7_iter,$iter8_type,$iter10_idx,$iter8_nextval,$iter7_idx,y_board,b,$iter7_nextval,g,$iter7_array,$iter8_array,$iter10_array,x_cell,$iter10_type,$iter9_array;
