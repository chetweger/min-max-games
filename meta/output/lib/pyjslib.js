...
(function(){
	...
	$m['tuple'] = (function(){
		...
		var $method;
		$cls_definition['__module__'] = 'pyjslib';
		$cls_definition['__md5__'] = '1ce70d1e551723c3f3c8b8ab53a60ca2';
...
$m['tuple']['toString'] = $m['tuple']['__str__'];
	$m['NotImplementedType'] = (function(){
		...
		var $method;
		$cls_definition['__module__'] = 'pyjslib';
		$cls_definition['__md5__'] = 'e2a8c0917991a64331cd78cc9be71826';
		$method = $pyjs__bind_method2('__repr__', function() {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
...
$enumerate_array['prototype']['$genfunc'] = $enumerate_array['prototype']['next'];
	...
	$m['list'] = (function(){
		...
		var $method;
		$cls_definition['__module__'] = 'pyjslib';
		$cls_definition['__md5__'] = 'c5ae477ecf1d8872240ef8d093ec7be5';
		$method = $pyjs__bind_method2('__init__', function(data) {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
...
$m['list']['toString'] = $m['list']['__str__'];
	$m['slice'] = (function(){
		...
		var $method;
		$cls_definition['__module__'] = 'pyjslib';
		$cls_definition['__md5__'] = 'd8e12fde81313ae13d92f6f767548003';
...
$m['slice']['toString'] = $m['slice']['__str__'];
	$m['dict'] = (function(){
		...
		var $method;
		$cls_definition['__module__'] = 'pyjslib';
		$cls_definition['__md5__'] = '9848f9198ae241abd34e487e46d80a27';
...
$m['dict']['__str__'] = $m['dict']['__repr__'];
	...
	$m['set'] = (function(){
		...
		var $method;
		$cls_definition['__module__'] = 'pyjslib';
		$cls_definition['__md5__'] = '8c5cdd561dc59a9521e9e86f1d01b603';
...
$m['set']['toString'] = $m['set']['__repr__'];
	$m['frozenset'] = (function(){
		...
		var $method;
		$cls_definition['__module__'] = 'pyjslib';
		$cls_definition['__md5__'] = '20b58db3c81887e7677e2a58db13decf';
		$method = $pyjs__bind_method2('__init__', function(_data) {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
...
$m['frozenset']['toString'] = $m['frozenset']['__repr__'];
	$m['property'] = (function(){
		...
		var $method;
		$cls_definition['__module__'] = 'pyjslib';
		$cls_definition['__md5__'] = 'c0473ca44ef872449ae5fe01a0e4234b';
	...
	$m['str'] = (function(){
		...
		var $method;
		$cls_definition['__module__'] = 'pyjslib';
		$cls_definition['__md5__'] = '58e9a8633a7785df9349655b7a00a182';
...
var $generator_state = [0], $generator_exc = [null], $yield_value = null, $exc = null, $is_executing=false;
	...
	$m['complex'] = (function(){
		...
		var $method;
		$cls_definition['__module__'] = 'pyjslib';
		$cls_definition['__md5__'] = '5c74a589ce409a0669e37b3643499f2e';
...
r = Math['round'](n*x)/n;
	...
	$m['StringBuilder'] = (function(){
		...
		var $method;
		$cls_definition['__module__'] = 'pyjslib';
		$cls_definition['__md5__'] = '957ab6701443ad3e1f5532258451ef85';
		$method = $pyjs__bind_method2('__init__', function() {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
	...
	$m['TemplateFormatter'] = (function(){
		...
		var $method;
		$cls_definition['__module__'] = 'pyjslib';
		$cls_definition['__md5__'] = 'bbb7c60ae98090c60387b32e288abb90';
	...
	$m['NumberSpec'] = (function(){
		...
		var $method;
		$cls_definition['__module__'] = 'pyjslib';
		$cls_definition['__md5__'] = 'd6caf8f2a83df31602750747ecdabced';
		var $bases = new Array($m['object']);
	...
	$m['BaseFormatter'] = (function(){
		...
		var $method;
		$cls_definition['__module__'] = 'pyjslib';
		$cls_definition['__md5__'] = 'cdc83660162c606ab3774425f7d680a7';
	...
	$m['Formatter'] = (function(){
		...
		var $method;
		$cls_definition['__module__'] = 'pyjslib';
		$cls_definition['__md5__'] = 'a55a5e8283e1b6cfe2e285d44b4fa67a';
	...
	$m['StringFormatSpace'] = (function(){
		...
		var $method;
		$cls_definition['__module__'] = 'pyjslib';
		$cls_definition['__md5__'] = 'e9ba54682383146bca0536e9c9fe37be';
